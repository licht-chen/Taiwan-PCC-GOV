# -*- coding: utf-8 -*-
"""
Created on Sun Nov 14 10:42:37 2021
...
today = date.today()
headlist = ["項次", "機關名稱", "標案案號", "標案名稱", "傳輸次數", "招標方式",
        "採購性質", "公告日期", "截止投標", "預算金額", "公開招標公告網址"]
origin_href = "https://web.pcc.gov.tw/prkms/tender/common/advanced/readTenderAdvanced?"
project_href = "https://web.pcc.gov.tw/tps/QueryTender/query/searchTenderDetail?pkPmsMain="
url = origin_href
### 特殊字元 replace
...
def pcc_gov_search_basic(orgname, startdate, enddate, search_type, mon_folder):
    # orgname = '中華郵政'
    # search_type = "招標公告"
    # orgname = '中央銀行'
    # orgname = '金融監督管理委員會'
